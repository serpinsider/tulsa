    ...
    return [
      {
        ...
        headers: [
          // Content Security Policy - controls what resources can load
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.usefathom.com https://accounts.google.com https://apis.google.com https://maps.googleapis.com https://js.stripe.com https://us-assets.i.posthog.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "font-src 'self' https://fonts.gstatic.com data:",
              "img-src 'self' data: https: blob:",
              "media-src 'self' blob:",
              "connect-src 'self' https://cdn.usefathom.com https://*.googleapis.com https://*.googleusercontent.com https://us.i.posthog.com https://us-assets.i.posthog.com https://formspree.io https://maidcrm.com https://*.serpinsiders-projects.vercel.app https://api.stripe.com https://m.stripe.network https://m.stripe.com",
