          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-white/10 rounded-lg p-6 border border-white/20">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3 text-white/80">
                    <svg className="w-5 h-5 text-[#dfbd69] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <div>
                      <p>Service Areas:</p>
                      <p className="text-sm text-white/70">Brooklyn, Manhattan, Queens, Bronx, Staten Island, Jersey City</p>
                    </div>
                  </div>
              ...
              <div className="bg-white/10 rounded-lg p-6 border border-white/20">
                ...
                <div className="space-y-3">
                  <a href="/quote" className="block text-[#dfbd69] hover:text-[#dfbd69]/80 transition-colors">
                    → Get a cleaning quote
                  </a>
                  <a href="/services/carpet-cleaning/quote" className="block text-[#dfbd69] hover:text-[#dfbd69]/80 transition-colors">
                    → Get a carpet cleaning quote
                  </a>
                  <a href="/services/handyman/quote" className="block text-[#dfbd69] hover:text-[#dfbd69]/80 transition-colors">
            ...
            <div className="bg-white/10 rounded-lg p-6 border border-white/20">
              ...
              <form className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-[#dfbd69] text-slate-900 px-8 py-4 rounded-lg font-semibold hover:bg-[#dfbd69]/90 transition-colors"
                >
                  Send Message
                </button>
              </form>
