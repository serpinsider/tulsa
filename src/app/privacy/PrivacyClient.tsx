      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[${COLORS.brand.gold}] mb-6">Information We Collect</h2>
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[${COLORS.brand.gold}] mb-6">How We Use Your Information</h2>
            <div className="space-y-4 text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[${COLORS.brand.gold}] mb-6">Information Sharing</h2>
            <div className="space-y-4 text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[${COLORS.brand.gold}] mb-6">Data Security</h2>
            <div className="space-y-4 text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[${COLORS.brand.gold}] mb-6">Your Rights</h2>
            <div className="space-y-4 text-white/80">
