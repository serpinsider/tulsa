...
export const metadata: Metadata = {
  ...
  description:
    "Schedule your cleaning service with Tulsa Maids. Our easy booking system lets you customize your cleaning needs and find the perfect time slot for your schedule.",
  openGraph: {
    title: "Book Your Cleaning - Tulsa Maids",
    description:
      "Book your home cleaning service in minutes. Choose your cleaning type, schedule your preferred date and time, and let Tulsa Maids take care of the rest.",
...
export default function BookingPage() {
  const accent = STEP_WIZARD_CONFIG.accentColor;
  return (
    <main
