...
export default function AirbnbStepWizard({ onFormExpand }: AirbnbStepWizardProps) {
  ...
  if (currentStep === 4) return <SuccessMessage type="quote" confirmationNumber={formData.confirmationNumber} serviceLabel="Airbnb cleaning" inline={true} onClose={handleCloseSuccess} />;
