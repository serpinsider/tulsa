...
export default function DeepCleanService() {
  ...
  return (
    <>
      ...
      <DeepCleanHero location="Tulsa, OK" />
      <QuoteBar />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {whenToBook.map((item, index) => (
              <div 
                key={index}
                className="bg-[rgba(22,48,75,0.95)] backdrop-blur-md rounded-xl border border-white/10 p-6 hover:bg-[rgba(22,48,75,0.98)] transition-all"
              >
